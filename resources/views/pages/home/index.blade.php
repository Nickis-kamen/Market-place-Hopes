...
<section id="section-1" class="relative h-screen bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('images/bg-header.jpg') }}');">
            ...
            <form class="max-w-lg">
                ...
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                    ...
                    <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-md w-44">
                        ...
                        <li>
                            <button type="button" class="cursor-pointer w-full px-4 py-2 hover:bg-gray-300">{{ $category->title }}</button>
                        </li>
                        @endforeach
                    ...
                    <div class="relative w-full">
                        <input type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-100 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:placeholder-gray-400 dark:focus:border-blue-500" placeholder="Search" required />
    ...
    <section class="py-10 sm:ml-64 bg-cover" style="background-image: url('{{ asset('images/waves.svg') }}');">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 px-4">
            ...
            <div class="backdrop-blur-lg bg-white/10 border border-white/20 rounded-xl shadow-lg p-4 text-center">
                ...
                <p class="text-white font-bold mb-2">{{ $product->price }} €</p>
