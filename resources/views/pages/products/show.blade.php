    ...
    {{-- Grille image + infos --}}
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10 bg-white p-6 rounded-2xl shadow-lg">
                ...
                <div class="bg-cover rounded-2xl">
                    <img src="/storage/{{ $product->image }}" alt="{{ $product->title }}" class="w-full max-w-md h-auto rounded-xl shadow-md bg-cover bg-no-repeat" style="background-image: url('{{ asset('images/wave.svg') }}');">
                </div>
                ...
                <div class="flex flex-col justify-between">
                    ...
                    {{-- Bouton acheter --}}
                    <div class="mt-6">
                        <button class="w-full bg-blue-600 text-white py-3 rounded-lg text-lg hover:bg-blue-700 transition">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div class="w-full mt-10 bg-white p-6 rounded-2xl shadow-md">
                    <h2 class="text-2xl font-semibold text-gray-800 mb-4">Avis des clients</h2>
                ...
                <div class="mt-10 bg-gray-50 p-6 rounded-xl shadow">
                    ...
                    <form action="{{ route('ratings.store') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            @endif
                            <label class="block text-gray-600 mb-1">Votre note</label>
                        ...
                        <div>
                            ...
                            <textarea name="comment" rows="3" class="w-full border rounded-lg p-2" placeholder="Votre commentaire (facultatif)"></textarea>
                        </div>
