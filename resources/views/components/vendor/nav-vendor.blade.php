<nav class="fixed w-full z-20 top-0 start-0 bg-gradient-to-r from-blue-500 to-blue-800 text-white" >
    ...
    <span class="self-center text-2xl font-semibold whitespace-nowrap">Espace vendeur</span>
