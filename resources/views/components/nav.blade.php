<nav class="fixed w-full z-50 top-0 start-0 bg-gradient-to-r from-blue-800 to-blue-00 text-white" id="navbar">
    ...
    <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        ...
        @else
            <a class="hidden md:block cursor-pointer text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focu s:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mx-2" href="{{ route('auth.register.customer') }}">Inscription</a>
        ...
        <button id="btn" data-collapse-toggle="navbar-sticky" type="button" class="cursor-pointer inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-white rounded-lg md:hidden hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="navbar-sticky" aria-expanded="false">
